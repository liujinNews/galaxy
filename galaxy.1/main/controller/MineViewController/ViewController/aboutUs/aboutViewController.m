...
- (void)viewDidLoad {
  ...
  @[@{@"image":@"set_info",@"companyType":Custing(@"版本信息", nil),@"tag":@"Version"},
    @{@"image":@"set_user",@"companyType":Custing(@"用户协议", nil),@"tag":@"userAgreement"},
    @{@"image":@"set_privacy",@"companyType":Custing(@"隐私协议", nil),@"tag":@"privacyAgreement"},
    @{@"image":@"set_about",@"companyType":Custing(@"关于喜报", nil),@"tag":@"aboutXB"}],
