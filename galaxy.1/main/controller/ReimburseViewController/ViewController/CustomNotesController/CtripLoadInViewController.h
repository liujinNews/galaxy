...
@interface CtripLoadInViewController : VoiceBaseController<UIScrollViewDelegate,GPClientDelegate,UICollectionViewDelegate,UICollectionViewDataSource>
