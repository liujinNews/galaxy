...
@interface DailyAppoverController : VoiceBaseController<GPClientDelegate,UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource,ByvalDelegate,ReimShareDelegate>
/**
 表单上数据
 */
