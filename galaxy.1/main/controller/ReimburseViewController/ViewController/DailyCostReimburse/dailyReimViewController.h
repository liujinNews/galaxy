...
@interface dailyReimViewController : VoiceBaseController<UIScrollViewDelegate,GPClientDelegate,UITableViewDelegate,UITableViewDataSource,ByvalDelegate,ReimShareDelegate,UITextFieldDelegate>

/**
 表单上数据
 */
@property (nonatomic,strong)dailyReimFormData *FormDatas;
/**
 *  滚动视图
 */
 ...
 *  供应商银行名称视图
 */
@property(nonatomic,strong)UIView *View_SupplierBankName;
@property(nonatomic,strong)UITextField *txf_SupplierBankName;
/**
 *  供应商银行账号视图
 */
@property(nonatomic,strong)UIView *View_SupplierBankAccount;
@property(nonatomic,strong)UITextField *txf_SupplierBankAccount;
/**
 *  业务招待视图
 */
