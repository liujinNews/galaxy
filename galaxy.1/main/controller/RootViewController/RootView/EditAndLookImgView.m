...
//    if ([type isEqualToString:@".pdf"]||[type isEqualToString:@".doc"]||[type isEqualToString:@".docx"]||[type isEqualToString:@".xls"]||[type isEqualToString:@".xlsx"]||[type isEqualToString:@".txt"]||[type isEqualToString:@"XLSX"]||[type isEqualToString:@"DOCX"]||[type isEqualToString:@"PDF"]) {
...
//    }
    if ([type containsString:@"pdf"]||[type containsString:@"doc"]||[type containsString:@"docx"]||[type containsString:@"xls"]||[type containsString:@"txt"]) {
          [self showFileWithUrlDate:_totalArray[index][@"filepath"]];
      }else if([type containsString:@"zip"]||[type containsString:@"rar"]||[type containsString:@"7z"]||[type containsString:@"csv"]){
          UIViewController *vc=[GPUtils getCurrentVC];
          [[GPAlertView sharedAlertView]showAlertText:vc WithText:Custing(@"文件暂不支持本地查看", nil) duration:2.0];
      }else{
          [self showImageWithImageDate:_imageArray WithIndex:index];
