...
-(void)configCellHasAddWith:(NSMutableArray *)imageArray withRow:(NSInteger)row{
    ...
    _PhotoImgView.backgroundColor=Color_form_TextFieldBackgroundColor;
