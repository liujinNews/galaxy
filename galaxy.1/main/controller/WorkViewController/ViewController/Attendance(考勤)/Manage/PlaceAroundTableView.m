...
- (void)onPOISearchDone:(AMapPOISearchBaseRequest *)request response:(AMapPOISearchResponse *)response
{
    if (self.isFromMoreButton == YES)
    {
        ...
        self.moreButton.backgroundColor = Color_form_TextFieldBackgroundColor;
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0)
    {
        ...
        [self.delegate didPositionCellTapped:self.currentRedWaterPosition];
        return ;
    }
...
- (void)initTableViewFooter
{
    ...
    [moreBtn setTitleColor:Color_Unsel_TitleColor forState:UIControlStateNormal];
