...
-(void)createMainView{
    ...
    scrollView.scrollEnabled =(Main_Screen_Height-NavBarHeight<60*9);
    ...
    [ViewCode addSubview:[[SubmitFormView alloc]initBaseView:ViewCode WithContent:_txf_code WithFormType:formViewEnterText WithSegmentType:lineViewNoneLine WithString:Custing(@"编号", nil) WithInfodict:nil WithTips:Custing(@"请输入编号", nil) WithNumTitle:200]];
    ...
    [ViewNameCh addSubview:[[SubmitFormView alloc]initBaseView:ViewNameCh WithContent:_txf_nameCh WithFormType:formViewEnterText WithSegmentType:lineViewNoneLine WithString:Custing(@"产品", nil) WithInfodict:nil WithTips:Custing(@"请输入产品", nil) WithNumTitle:200]];
    ...
    [ViewNameEn addSubview:[[SubmitFormView alloc]initBaseView:ViewNameEn WithContent:_txf_nameEn WithFormType:formViewEnterText WithSegmentType:lineViewNoneLine WithString:Custing(@"英文名称", nil) WithInfodict:nil WithTips:Custing(@"请输入英文名称", nil) WithNumTitle:200]];
    ...
    SubmitFormView *view=[[SubmitFormView alloc]initBaseView:ViewCate WithContent:_txf_cat WithFormType:formViewSelect WithSegmentType:lineViewNoneLine WithString:Custing(@"产品类型", nil) WithInfodict:nil WithTips:Custing(@"请选择产品类型", nil) WithNumTitle:200];
    ...
    [ViewBrandCh addSubview:[[SubmitFormView alloc]initBaseView:ViewBrandCh WithContent:_txf_brandCh WithFormType:formViewEnterText WithSegmentType:lineViewNoneLine WithString:Custing(@"品牌", nil) WithInfodict:nil WithTips:Custing(@"请输入品牌", nil) WithNumTitle:200]];
    ...
    [ViewBrandEn addSubview:[[SubmitFormView alloc]initBaseView:ViewBrandEn WithContent:_txf_brandEn WithFormType:formViewEnterText WithSegmentType:lineViewNoneLine WithString:Custing(@"品牌英文名称", nil) WithInfodict:nil WithTips:Custing(@"请输入品牌英文名称", nil) WithNumTitle:200]];
    ...
    [ViewSize addSubview:[[SubmitFormView alloc]initBaseView:ViewSize WithContent:_txf_size WithFormType:formViewEnterText WithSegmentType:lineViewNoneLine WithString:Custing(@"规格", nil) WithInfodict:nil WithTips:Custing(@"请输入规格", nil) WithNumTitle:200]];
    ...
    [ViewUnit addSubview:[[SubmitFormView alloc]initBaseView:ViewUnit WithContent:_txf_unit WithFormType:formViewEnterText WithSegmentType:lineViewNoneLine WithString:Custing(@"单位", nil) WithInfodict:nil WithTips:Custing(@"请输入单位", nil) WithNumTitle:200]];
