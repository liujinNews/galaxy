...
@interface OutGoingData : NSObject
...
@property (nonatomic, copy) NSString *OutTypeId;
...
@property (nonatomic, copy) NSString *VisitObject;
...
@property (nonatomic, copy) NSString *ActualFromDate;
@property (nonatomic, copy) NSString *ActualToDate;
@property (nonatomic, copy) NSString *ActualOutTime;
