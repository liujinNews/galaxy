...
@interface RemittanceData : NSObject
...
@property (nonatomic, copy) NSString *ClaimAmount;
@property (nonatomic, copy) NSString *CapitalizedAmount;
@property (nonatomic, copy) NSString *TotalReceivables;
@property (nonatomic, copy) NSString *TotalDeduction;
@property (nonatomic, copy) NSString *AccumulativeInvoice;
@property (nonatomic, copy) NSString *FormalityCompliance;
@property (nonatomic, copy) NSString *ApprovalAmount;
@property (nonatomic, copy) NSString *ApprovalCapitalizedAmount;
@property (nonatomic, copy) NSString *PaymentAmount;
@property (nonatomic, copy) NSString *PaymentCapitalizedAmount;
...
+ (NSMutableDictionary *) initDicByModel:(RemittanceData *)model;
