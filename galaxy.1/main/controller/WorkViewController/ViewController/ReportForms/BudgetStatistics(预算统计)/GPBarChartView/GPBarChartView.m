...
@interface GPBarChartView () <GPXBarViewDelegate>

@property (strong, nonatomic) UIScrollView *scrollView;
@property (strong, nonatomic) GPXBarView *xBarView;
@property (strong, nonatomic) GPYBarView *yBarView;
@property (assign, nonatomic) CGFloat gap;

@end

@implementation GPBarChartView
...
- (void)commonInit {
    ...
    // 添加x轴与y轴视图
    GPYBarView *yBarView = [[GPYBarView alloc] init];
    
    [self addSubview:yBarView];
    
    UIScrollView *scrollView = [[UIScrollView alloc] init];
    
    GPXBarView *xBarView = [[GPXBarView alloc] init];
