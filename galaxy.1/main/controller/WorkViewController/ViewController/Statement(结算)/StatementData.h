...
@interface StatementData : NSObject
...
@property (nonatomic, copy) NSString *EpcName;
@property (nonatomic, copy) NSString *SubcontractorName;
...
@property (nonatomic, copy) NSString *AcceptanceDate;
@property (nonatomic, copy) NSString *SettlementDate;
@property (nonatomic, copy) NSString *DeductionAmount;
@property (nonatomic, copy) NSString *DeductionAttachment;
@property (nonatomic, copy) NSString *SettlementPrice;
@property (nonatomic, copy) NSString *SettlementAttachment;
