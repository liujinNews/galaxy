...
@interface StatementHasController ()

@end

@implementation StatementHasController

-(instancetype)init{
    self = [super init];
    if (self) {
        self.FormDatas = [[StatementFormData alloc]initWithStatus:2];
    }
    return self;
}
- (void)viewDidLoad {
...
-(void)updateMainView{
    ...
    for (MyProcurementModel *model in self.FormDatas.arr_FormMainArray) {
        ...
        }else if ([model.fieldName isEqualToString:@"DeductionAttachment"]&&[[model.isShow stringValue]isEqualToString:@"1"]&&self.FormDatas.arr_DedueTolArray.count!=0) {
            _int_line1 = 1;
        ...
        }else if ([model.fieldName isEqualToString:@"SettlementAttachment"]&&[[model.isShow stringValue]isEqualToString:@"1"]&&self.FormDatas.arr_SettleTolArray.count!=0) {
            _int_line1 = 1;
...
-(void)updateEpcNameViewWithModel:(MyProcurementModel *)model{
    [_View_EpcName addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_EpcName updateConstraints:^(MASConstraintMaker *make) {
...
-(void)updateSubcontractorNameViewWithModel:(MyProcurementModel *)model{
    [_View_SubcontractorName addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_SubcontractorName updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateAcceptanceDateViewWithModel:(MyProcurementModel *)model{
    [_View_AcceptanceDate addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_AcceptanceDate updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateSettlementDateViewWithModel:(MyProcurementModel *)model{
    [_View_SettlementDate addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_SettlementDate updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateDeductionAmountViewWithModel:(MyProcurementModel *)model{
    [_View_DeductionAmount addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 IsAmount:1 block:^(NSInteger height) {
        [self.View_DeductionAmount updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateDeductionAttachmentViewWithModel:(MyProcurementModel *)model{
    EditAndLookImgView *view = [[EditAndLookImgView alloc]initWithBaseView:_View_DeductionAttachment withEditStatus:2 withModel:model];
    view.maxCount = 5;
...
-(void)updateSettlementPriceViewWithModel:(MyProcurementModel *)model{
    [_View_SettlementPrice addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 IsAmount:1 block:^(NSInteger height) {
        [self.View_SettlementPrice updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateSettlementAttachmentViewWithModel:(MyProcurementModel *)model{
    EditAndLookImgView *view=[[EditAndLookImgView alloc]initWithBaseView:_View_SettlementAttachment withEditStatus:2 withModel:model];
    view.maxCount = 5;
