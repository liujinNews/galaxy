//
//  WareHouseEntryApproveViewController.h
//  galaxy
//
...
@interface WareHouseEntryApproveViewController : VoiceBaseController<UIScrollViewDelegate,GPClientDelegate,UITableViewDelegate,UITableViewDataSource>
