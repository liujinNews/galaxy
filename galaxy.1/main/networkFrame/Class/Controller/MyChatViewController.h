...
@interface MyChatViewController : RootViewController<UITableViewDelegate, UITableViewDataSource, MyChatToolBarViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate,MyMoreViewDelegate,UIAlertViewDelegate>
{
    BOOL _isMySelfIsAdmin;
}
