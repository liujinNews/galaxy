...
- (UIView*)toolBarView{
    if (_toolBarView == nil) {
        ...
        _toolBarView.backgroundColor = Color_White_Same_20;
        UIImageView *image = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, Main_Screen_Width, 1)];
        image.backgroundColor = Color_GrayLight_Same_20;
        [_toolBarView addSubview:image];
    }
    return _toolBarView;
}
...
//        _recordView = [[MyAudioInputView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, CHAT_RECORD_VIEW_H)];
        _recordView = [[MyAudioInputView alloc] initWithFrame:_textInputView.frame];
...
- (void)setSubviewsLayout{
    ...
    self.audioBtn.frame = CGRectMake(CHAT_BAR_HORIZONTAL_PADDING, CHAT_BAR_VECTICAL_PADDING, CHAT_BAR_MIN_H, CHAT_BAR_MIN_H);
    
    CGFloat textInputWidth = Main_Screen_Width -CHAT_BAR_MIN_H*3 - CHAT_BAR_HORIZONTAL_PADDING*5;
    self.textInputView.frame = CGRectMake(CGRectGetMaxX(self.audioBtn.frame)+CHAT_BAR_HORIZONTAL_PADDING, CHAT_BAR_VECTICAL_PADDING, textInputWidth, CHAT_BAR_MIN_H);
    
    self.emojBtn.frame = CGRectMake(CGRectGetMaxX(_textInputView.frame)+CHAT_BAR_HORIZONTAL_PADDING, CHAT_BAR_VECTICAL_PADDING, CHAT_BAR_MIN_H, CHAT_BAR_MIN_H);
    self.moreBtn.frame = CGRectMake(kViewWidth-CHAT_BAR_HORIZONTAL_PADDING-CHAT_BAR_MIN_H, CHAT_BAR_VECTICAL_PADDING, CHAT_BAR_MIN_H, CHAT_BAR_MIN_H);
    ...
    self.recordView.frame = CGRectMake(CGRectGetMaxX(self.audioBtn.frame)+CHAT_BAR_HORIZONTAL_PADDING, CHAT_BAR_VECTICAL_PADDING, textInputWidth, CHAT_BAR_MIN_H);
...
- (void)updateButtomView:(UIView*)buttomView{
    ...
    if (buttomView != nil
        ...
        if ([buttomView class] == [MyAudioInputView class]) {
