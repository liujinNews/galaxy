...
- (UIButton *)deleleBtn{
    if (!_deleleBtn) {
        ...
        // 设置阴影
        deleleBtn.layer.shadowColor = Color_Unsel_TitleColor.CGColor;
...
- (UILabel *)pageLabel{
    if (!_pageLabel) {
        ...
        pageLabel.textColor = Color_form_TextFieldBackgroundColor;
...
- (void)showToView{
    ...
    mainView.backgroundColor = Color_Unsel_TitleColor;
    ...
    mainBgView.backgroundColor = Color_Unsel_TitleColor;
...
- (void)delete{
    ...
    UIAlertView *removeAlert = [[UIAlertView alloc]
                                initWithTitle:Custing(@"确定要删除此图片？", nil)
                                message:nil
                                delegate:self
