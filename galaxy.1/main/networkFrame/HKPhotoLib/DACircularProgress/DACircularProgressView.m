...
+ (void) initialize
{
    if (self == [DACircularProgressView class]) {
        ...
        [circularProgressViewAppearance setTrackTintColor:[Color_form_TextFieldBackgroundColor colorWithAlphaComponent:0.3f]];
        [circularProgressViewAppearance setProgressTintColor:Color_form_TextFieldBackgroundColor];
