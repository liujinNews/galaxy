...
{
    [self startGlowingWithColor:Color_form_TextFieldBackgroundColor fromIntensity:0 toIntensity:0.6 repeat:NO];
...
- (void)startGlowing
{
    [self startGlowingWithColor:Color_form_TextFieldBackgroundColor intensity:0.6];
}
