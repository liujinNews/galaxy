...
#define loaderBackgroundColor [UIColor colorWithWhite:1 alpha:0]
#define loaderCornerRadius 0
#define loaderBackgroundWidth ([UIScreen mainScreen].applicationFrame.size.width)
#define loaderBackgroundHeight ([UIScreen mainScreen].applicationFrame.size.height)
...
#define animationImageWidth  200
#define animationImageHeight 200
#define numberOfFramesInAnimation 8
#define spriteNameString @"Preloader_0000"
