...
//开发17_8401
#define XBServer_T17_8401         @"http://10.1.2.17:8401/api/"
...
#define GetAccruedList @"Accrued/GetAccruedList"     //获取预提明细列表
...
//预提单申请
#define AccruedAppNewData @"Accrued/GetAccruedData"
#define AccruedAppHasData @"Accrued/GetFormData"
#define AccruedVerification @"Accrued/AccruedVerification";
