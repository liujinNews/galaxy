...
- (void)createTipsView{
    ...
    //将判断第一次打开的属性置为空，用户不做处理推出时依然是第一次打开
    NSUserDefaults *userDef = [NSUserDefaults standardUserDefaults];
    [userDef setObject:nil forKey:ISFISTRINSTALL];
    //创建视图
    float gapW = 15;
    float gapH = 20;
    float tipViewGapW ;
...
//    NSString *text5 = Custing(@"1.为了向您提供基本服务，我们会遵循正当，合法，必要的原则收集和使用必要的信息；\n\n2.基于您的授权我们可能会收集和使用您的位\n置信息以便为您推荐周边的生活服务，您有权拒绝或取消授权；\n\n3未经您的授权同意，我们不会将您的信息共享给第三方或用于您未授权的其他用途；\n\n4您可以对上述信息进行访问、更正、删除、以及注销账号。\n美团点评将一如既往坚守使命，帮助大家吃得更好，生活更好！", nil);
    ...
    NSString *text6 = Custing(@"2.基于您的授权我们可能会收集和使用您的位置信息以便为您推荐周边的生活服务，您有权拒绝或取消授权；", nil);
    ...
    NSString *text9 = Custing(@"喜报将一如既往坚守使命，帮助大家吃得更好，生活更好！", nil);
    ...
    textLab9.attributedText = attributedString5;
    textLab9.text = text9;
