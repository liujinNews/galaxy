...
- (void)viewDidLoad {
    ...
    self.helpArray = @[@{@"helpImage":@"Newbie",@"helpType":Custing(@"新手入门", nil)},@{@"helpImage":@"managementManual",@"helpType":Custing(@"管理手册", nil)},@{@"helpImage":@"my_CommonProblems",@"helpType":Custing(@"常见问题", nil)}];
