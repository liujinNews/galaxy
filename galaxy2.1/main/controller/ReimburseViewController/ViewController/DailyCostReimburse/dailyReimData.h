...
@interface dailyReimData : NSObject
...
@property (nonatomic, copy) NSString *SpecialRequirementsNumber;
@property (nonatomic, copy) NSString *SpecialRequirementsInfo;
@property (nonatomic, copy) NSString *EmployeeTrainingNumber;
@property (nonatomic, copy) NSString *EmployeeTrainingInfo;
...
@property (nonatomic, copy) NSString *EntertainAppNumber;
@property (nonatomic, copy) NSString *EntertainAppInfo;
@property (nonatomic, copy) NSString *VehicleSvcAppNumber;
@property (nonatomic, copy) NSString *VehicleSvcAppInfo;
...
@property (nonatomic, copy) NSString *SupplierBankName;
@property (nonatomic, copy) NSString *SupplierBankAccount;
