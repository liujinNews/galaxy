...
@interface MyPaymentApproveController : VoiceBaseController<GPClientDelegate,UIScrollViewDelegate,ReimShareDelegate,UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
/**
 表单上数据
 */
