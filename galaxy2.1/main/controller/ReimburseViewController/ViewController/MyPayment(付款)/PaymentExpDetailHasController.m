...
-(void)createMainView{
    ...
    //预提明细列表视图
    _View_AccruedForm=[[MulChooseShowView alloc]initWithStatus:2 withFlowCode:@"F0001"];
...
-(void)updateCostTypeViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
    model1.fieldValue = self.PaymentExpDetail.CostType;
...
-(void)updateIsStorageViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
//    model1.fieldValue = self.PaymentExpDetail.IsStorage;
    if ([self.PaymentExpDetail.IsStorage isEqualToString:@"1"]) {
        model1.fieldValue = Custing(@"是", nil);
    }else if([self.PaymentExpDetail.IsStorage isEqualToString:@"0"]){
...
-(void)updateIsPrepayViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
//    model1.fieldValue = self.PaymentExpDetail.IsPrepay;
    if ([self.PaymentExpDetail.IsPrepay isEqualToString:@"1"]) {
           model1.fieldValue = Custing(@"是", nil);
       }else if([self.PaymentExpDetail.IsPrepay isEqualToString:@"0"]){
           model1.fieldValue = Custing(@"否", nil);
       }
...
-(void)updatePrepayStartDateViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
    model1.fieldValue = self.PaymentExpDetail.PrepayStartDate;
...
-(void)updatePrepayEndDateViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
    model1.fieldValue = self.PaymentExpDetail.PrepayEndDate;
...
-(void)updateIsAccruedaccountViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
//    model1.fieldValue = self.PaymentExpDetail.IsAccruedaccount;
    if ([self.PaymentExpDetail.IsAccruedaccount isEqualToString:@"1"]) {
        model1.fieldValue = Custing(@"是", nil);
        [self updateSa_PaymentExpDetailRelevanceAccruedExpDetailViewl];
    }else if([self.PaymentExpDetail.IsAccruedaccount isEqualToString:@"0"]){
        model1.fieldValue = Custing(@"否", nil);
    }
...
- (NSMutableArray *)accruedArr{
    if (_accruedArr == nil) {
        _accruedArr = [NSMutableArray arrayWithCapacity:42];
    }
    return _accruedArr;
}
//MARK:更新预提明细表
...
-(void)updateGovernmentViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
//    model1.fieldValue = self.PaymentExpDetail.Government;
    if ([self.PaymentExpDetail.Government isEqualToString:@"1"]) {
        model1.fieldValue = Custing(@"是", nil);
    }else if([self.PaymentExpDetail.Government isEqualToString:@"0"]){
        model1.fieldValue = Custing(@"否", nil);
    }
...
-(void)updateCostCenterViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
    model1.fieldValue = self.PaymentExpDetail.CostCenter;
...
-(void)updateFeeAppNumberViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
    model1.fieldValue = self.PaymentExpDetail.FeeAppInfo;
...
-(void)updateIsSettlementViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
//    model1.fieldValue = self.PaymentExpDetail.IsSettlement;
    if ([self.PaymentExpDetail.IsSettlement isEqualToString:@"1"]) {
        model1.fieldValue = Custing(@"是", nil);
    }else if([self.PaymentExpDetail.IsSettlement isEqualToString:@"0"]){
        model1.fieldValue = Custing(@"否", nil);
    }
...
-(void)updateAccountItemViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
    model1.fieldValue = self.PaymentExpDetail.AccountItem;
...
-(void)updateAccountItemAmountViewWithModel:(MyProcurementModel *)model{
    model.fieldValue = [NSString stringWithIdOnNO:self.PaymentExpDetail.AccountItemAmount];
...
-(void)updateAccountItem2ViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
    model1.fieldValue = self.PaymentExpDetail.AccountItem2;
...
-(void)updateAccountItemAmount2ViewWithModel:(MyProcurementModel *)model{
    model.fieldValue = [NSString stringWithIdOnNO:self.PaymentExpDetail.AccountItemAmount2];
...
-(void)updateAccountItem3ViewWithModel:(MyProcurementModel *)model{
    MyProcurementModel *model1 = [model copy];
    model1.fieldValue = self.PaymentExpDetail.AccountItem3;
...
-(void)updateAccountItemAmount3ViewWithModel:(MyProcurementModel *)model{
    model.fieldValue = [NSString stringWithIdOnNO:self.PaymentExpDetail.AccountItemAmount3];
