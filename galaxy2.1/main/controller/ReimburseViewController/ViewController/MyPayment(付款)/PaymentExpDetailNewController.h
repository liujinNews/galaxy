...
@property (nonatomic, copy)MyProcurementModel *model_AccruedForm;
...
//1新增2修改
@property (nonatomic, copy) void(^PaymentExpDetailAddEditBlock)(PaymentExpDetail *model, NSInteger type,NSMutableArray *accruedArr);
