...
@interface WeChatInvoiceController : VoiceBaseController<UIScrollViewDelegate,GPClientDelegate,UICollectionViewDelegate,UICollectionViewDataSource>
/**
 *  请求结果字典
 */
