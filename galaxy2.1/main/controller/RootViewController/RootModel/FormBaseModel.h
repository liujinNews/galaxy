...
@property (nonatomic, assign) BOOL bool_SecHaveAttchs;
...
@property (nonatomic, strong) MyProcurementModel *OperatorUserId;
...
@property (nonatomic, assign) NSInteger int_SubmitSaveType;// 1 数据保存 2数据提交 3数据直送
