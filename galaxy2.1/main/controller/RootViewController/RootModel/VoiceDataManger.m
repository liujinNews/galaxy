...
-(NSDictionary *)getControllerNameWithFlowCode:(NSString *)flowCode{
    ...
    }else if([flowCode isEqualToString:@"F0039"]){
        dict=@{@"pushController":@"AccruedNewViewController",
               @"pushHasController":@"AccruedHasViewController"
               };
    }
    return dict;
}
