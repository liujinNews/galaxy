...
//        _ExpenseCBtn = [GPUtils createButton:CGRectMake(40, 0, Main_Screen_Width - 40, 42) action:@selector(ExpenseCBtn:) delegate:self];
        ...
        if (![deModel.Attachments isKindOfClass:[NSNull class]]) {
    ...
    if (index!=count-1) {
        ...
        UIView *lineView=[[UIView alloc]initWithFrame:CGRectMake(X(_titleLabel), orginH, Main_Screen_Width-X(_titleLabel), 1)];
