...
//    [userContentController addScriptMessageHandler:self name:@"iOSExitFlow"];
...
- (void)dealloc{
    ...
    [self.webView.configuration.userContentController removeScriptMessageHandlerForName:@"iOSExit"];
...
//    if ([message.name isEqualToString:@"iOSExitFlow"]) {
...
//   [webView evaluateJavaScript:[NSString stringWithFormat:@"AliData('%@')",self.token] completionHandler:nil];
