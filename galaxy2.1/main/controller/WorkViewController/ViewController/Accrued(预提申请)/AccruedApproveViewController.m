//
//  AccruedApproveViewController.m
//  galaxy
//
...
#import "AccruedApproveViewController.h"
#import "MyPaymentApproveController.h"
#import "SelectCardViewController.h"

@interface AccruedApproveViewController ()

@end

@implementation AccruedApproveViewController

-(instancetype)init{
    self = [super init];
    if (self) {
        self.FormDatas=[[AccruedFormData alloc]initWithStatus:3];
    }
    return self;
}
...
-(void)updateAccruedReqDetailView{
    if (self.FormDatas.int_comeEditType == 1 || self.FormDatas.int_comeEditType == 5) {
        ...
        [_AccruedReqDetailView updatePaymentExpMainViewWithData:self.FormDatas.arr_DetailsDataArray WithEditType:3];
        __weak typeof(self) weakSelf = self;
        _AccruedReqDetailView.AccruedReqBackClickedBlock = ^(NSInteger type, NSInteger index, AccruedReqDetail * _Nonnull model) {
            ...
            vc.AccruedReqDetailAddEditBlock = ^(AccruedReqDetail * _Nonnull model, NSInteger type,NSMutableArray *accruedArr) {
                ...
                [weakSelf.AccruedReqDetailView updateTableView];
