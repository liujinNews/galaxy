...
@interface AccruedDetailLeadController ()<UISearchBarDelegate,GPClientDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation AccruedDetailLeadController
