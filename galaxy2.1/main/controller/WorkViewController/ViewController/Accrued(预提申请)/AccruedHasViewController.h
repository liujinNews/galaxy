...
@interface AccruedHasViewController : VoiceBaseController<GPClientDelegate,UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource>
/**
 表单上数据
 */
 ...
 *按照金额进行汇总视图
 */
@property (nonatomic,strong)UITableView *View_SummaryTable;
/**
 *  采购审批人视图
 */
