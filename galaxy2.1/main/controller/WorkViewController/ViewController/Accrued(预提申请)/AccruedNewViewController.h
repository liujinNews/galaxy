...
@interface AccruedNewViewController : VoiceBaseController<UIScrollViewDelegate,GPClientDelegate,UITableViewDelegate,UITableViewDataSource,ReimShareDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
/**
 表单上数据
 */
 ...
 *合同分期付款详情视图
 */
@property(nonatomic,strong)UIView *View_ContractPayDetail;
@property (nonatomic, strong) UILabel *lab_ContractPayDetail;
...
/**
 费用明细
 */
@property (nonatomic,strong)AccruedReqDetailView *accruedRDView;
/**
 *  是否有发票视图
 */
