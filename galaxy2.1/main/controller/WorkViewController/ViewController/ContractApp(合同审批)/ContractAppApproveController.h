//
//  ContractAppApproveController.h
//  galaxy
//
...
@interface ContractAppApproveController : VoiceBaseController<UIScrollViewDelegate,GPClientDelegate,ByvalDelegate,UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
//*  是否使用标准合同模版
//*/
//@property (nonatomic, strong) UIView *view_StdConTemplate;//是否使用标准模版合同
//@property (nonatomic, copy) NSString *str_StdConTemplate;
//@property (nonatomic, strong) NSMutableArray *array_StdConTemplate;
/**
...
* 付款方式明细表足
*/
@property(nonatomic,strong)UIView *View_PayFootView;
@property(nonatomic,strong)NSMutableArray *arr_expTTable;
@property(nonatomic,strong)NSMutableArray *arr_ExpTInSect;
/**
 * 费用类别明细视图
 */
