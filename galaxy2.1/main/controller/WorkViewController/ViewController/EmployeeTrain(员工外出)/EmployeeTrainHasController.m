...
@interface EmployeeTrainHasController ()

@end

@implementation EmployeeTrainHasController

-(instancetype)init{
    self = [super init];
    if (self) {
        self.FormDatas=[[EmployeeTrainFormData alloc]initWithStatus:2];
    }
    return self;
}
- (void)viewDidLoad {
...
-(void)createMainView{
    ...
    [_View_Institution makeConstraints:^(MASConstraintMaker *make) {
    ...
    [_View_Mode makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.View_Institution.bottom);
        make.left.right.equalTo(self.contentView);
    }];
    ...
    [_View_Location makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.View_Mode.bottom);
        make.left.right.equalTo(self.contentView);
    }];
    ...
    [_View_Days makeConstraints:^(MASConstraintMaker *make) {
    ...
    [_View_Fee makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.View_Days.bottom);
        make.left.right.equalTo(self.contentView);
    }];
    ...
    [_View_Content makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.View_Fee.bottom);
        make.left.right.equalTo(self.contentView);
    }];
    ...
    [_View_Certificate makeConstraints:^(MASConstraintMaker *make) {
...
-(void)updateMainView{
    ...
    for (MyProcurementModel *model in self.FormDatas.arr_FormMainArray) {
        if ([model.fieldName isEqualToString:@"TrainingName"]&&[[model.isShow stringValue]isEqualToString:@"1"]) {
            _int_line1=1;
            [self updateTrainingNameViewWithModel:model];
        }else if ([model.fieldName isEqualToString:@"TrainingInstitution"]&&[[model.isShow stringValue]isEqualToString:@"1"]) {
            _int_line1=1;
            [self updateTrainingInstitutionViewWithModel:model];
        }else if ([model.fieldName isEqualToString:@"TrainingMode"]&&[[model.isShow stringValue]isEqualToString:@"1"]) {
            _int_line1=1;
            [self updateTrainingModeNameViewWithModel:model];
        }else if ([model.fieldName isEqualToString:@"TrainingLocation"]&&[[model.isShow stringValue]isEqualToString:@"1"]) {
            _int_line1=1;
        ...
        }else if ([model.fieldName isEqualToString:@"Days"]&&[[model.isShow stringValue]isEqualToString:@"1"]) {
            _int_line1=1;
            [self updateDaysViewWithModel:model];
        }else if ([model.fieldName isEqualToString:@"TrainingFee"]&&[[model.isShow stringValue]isEqualToString:@"1"]) {
            _int_line1=1;
            [self updateTrainingFeeViewWithModel:model];
        }else if ([model.fieldName isEqualToString:@"TrainingContent"]&&[[model.isShow stringValue]isEqualToString:@"1"]) {
            _int_line1=1;
            [self updateTrainingContentViewWithModel:model];
        }else if ([model.fieldName isEqualToString:@"AssessmentMethod"]&&[[model.isShow stringValue]isEqualToString:@"1"]) {
            _int_line1=1;
            [self updateAssessmentMethodViewWithModel:model];
        }else if ([model.fieldName isEqualToString:@"TrainingCertificate"]&&[[model.isShow stringValue]isEqualToString:@"1"]) {
            _int_line1=1;
...
-(void)updateTrainingNameViewWithModel:(MyProcurementModel *)model{
    [_View_Name addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_Name updateConstraints:^(MASConstraintMaker *make) {
...
-(void)updateTrainingInstitutionViewWithModel:(MyProcurementModel *)model{
    [_View_Institution addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_Institution updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateTrainingModeNameViewWithModel:(MyProcurementModel *)model{
    [_View_Mode addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_Mode updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateTrainingLocationViewWithModel:(MyProcurementModel *)model{
    [_View_Location addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_Location updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateStartDateViewWithModel:(MyProcurementModel *)model{
    [_View_StartDate addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_StartDate updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateEndDateViewWithModel:(MyProcurementModel *)model{
    [_View_EndDate addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_EndDate updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateDaysViewWithModel:(MyProcurementModel *)model{
    [_View_Days addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_Days updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateTrainingFeeViewWithModel:(MyProcurementModel *)model{
    [_View_Fee addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 IsAmount:1 block:^(NSInteger height) {
        [self.View_Fee updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateTrainingContentViewWithModel:(MyProcurementModel *)model{
    [_View_Content addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_Content updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateAssessmentMethodViewWithModel:(MyProcurementModel *)model{
    [_View_Method addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_Method updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateTrainingCertificateViewWithModel:(MyProcurementModel *)model{
    [_View_Certificate addSubview:[XBHepler creation_Lable:[UILabel new] model:model Y:0 block:^(NSInteger height) {
        [self.View_Certificate updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(height);
        }];
    }]];
}
...
-(void)updateDetailsTableView{
    if (self.FormDatas.bool_isOpenDetail) {
        NSInteger height=10;
        for (EmployeeTrainDetail *model in self.FormDatas.arr_DetailsDataArray) {
            height=height+[ProcureDetailsCell EmployeeTrainingStaffCellHeightWithArray:self.FormDatas.arr_DetailsArray WithModel:model];
        }
        [_View_DetailsTable updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(@(height));
        }];
    }else{
        EmployeeTrainDetail *model=self.FormDatas.arr_DetailsDataArray[0];
        NSInteger height=10+[ProcureDetailsCell EmployeeTrainingStaffCellHeightWithArray:self.FormDatas.arr_DetailsArray WithModel:model];
        [_View_DetailsTable updateConstraints:^(MASConstraintMaker *make) {
            make.height.equalTo(@(height));
        }];
    }
...
{
    EmployeeTrainDetail *model=self.FormDatas.arr_DetailsDataArray[indexPath.row];
    return [ProcureDetailsCell EmployeeTrainingStaffCellHeightWithArray:self.FormDatas.arr_DetailsArray WithModel:model];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell configEmployeeTrainingStaffCellWithArray:self.FormDatas.arr_DetailsArray withDetailsModel:self.FormDatas.arr_DetailsDataArray[indexPath.row] withindex:indexPath.row withCount:self.FormDatas.arr_DetailsDataArray.count] ;
    if (cell.LookMore) {
