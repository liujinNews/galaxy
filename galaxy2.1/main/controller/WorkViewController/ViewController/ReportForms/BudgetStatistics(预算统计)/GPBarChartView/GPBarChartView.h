...
@class GPBarChartView;

@protocol GPBarChartViewDelegate <NSObject>

@optional
- (void)barChartView:(GPBarChartView *)barChartView didSelectedBarAtIndex:(NSInteger)index;

@end
@interface GPBarChartView : UIView

@property (weak, nonatomic) id<GPBarChartViewDelegate> delegate;
/**
 *  文字大小
 */
