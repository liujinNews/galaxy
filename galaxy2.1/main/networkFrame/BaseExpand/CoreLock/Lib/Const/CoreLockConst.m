...
/** 选中圆大小比例 */
const CGFloat CoreLockArcWHR = .25f;
...
/** 设置密码提示文字：确认 */
NSString *const CoreLockPWDTitleConfirm = @"确认新密码";


/** 设置密码提示文字：再次密码不一致 */
NSString *const CoreLockPWDDiffTitle = @"两次输入密码不一致";
...
/** 验证密码：密码错误次数过多 */
NSString *const CoreLockVerifyErrorPwdCountTitle = @"密码错误次数过多";
