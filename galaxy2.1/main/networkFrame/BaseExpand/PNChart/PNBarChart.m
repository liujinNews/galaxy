...
- (void)strokeChart
{
    ...
    if (_showChartBorder) {
        ...
        _chartBottomLine.fillColor    = [Color_form_TextFieldBackgroundColor CGColor];
        ...
        _chartLeftLine.fillColor    = [Color_form_TextFieldBackgroundColor CGColor];
  ...
  if (_showLevelLine) {
    ...
    _chartLevelLine.fillColor    = [Color_form_TextFieldBackgroundColor CGColor];
