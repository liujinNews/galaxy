...
+(void)updateImageDataWithTotalArray:(NSMutableArray *)tolArr WithImageArray:(NSMutableArray *)imgArr WithMaxCount:(NSInteger)maxcount{
    ...
    for (int i = 0; i<tolArr.count; i++) {
        if ([tolArr[i] isKindOfClass:[NSDictionary class]]) {
            ...
            if ([type isEqualToString:@".pdf"]||[type isEqualToString:@".doc"]||[type isEqualToString:@".docx"]||[type isEqualToString:@".xls"]||[type isEqualToString:@".xlsx"]||[type isEqualToString:@".csv"]||[type isEqualToString:@".txt"]||[type isEqualToString:@".zip"]||[type isEqualToString:@".rar"]||[type isEqualToString:@".7z"]) {
