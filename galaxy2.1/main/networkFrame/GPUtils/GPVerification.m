...
@implementation GPVerification
- (instancetype)initWithFrame:(CGRect)frame
{
    self = [super initWithFrame:frame];
    if (self)
    {
        self.backgroundColor = Color_Blue_Important_20;
...
- (void)drawRect:(CGRect)rect
{
    ...
    for ( int i = 0; i<text.length; i++)
    {
        ...
        [textC drawAtPoint:point withAttributes:@{NSForegroundColorAttributeName:Color_form_TextFieldBackgroundColor}];
    }
