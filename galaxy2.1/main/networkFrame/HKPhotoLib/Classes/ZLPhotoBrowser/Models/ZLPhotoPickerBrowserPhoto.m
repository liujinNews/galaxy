...
- (void)setPhotoObj:(id)photoObj{
    ...
    }else if ([photoObj isKindOfClass:[NSDictionary class]]){
//        NSMutableString *str=[NSMutableString stringWithFormat:@"%@",[photoObj objectForKey:@"filepath"]];
//        [str replaceCharactersInRange:NSMakeRange(7, 15) withString:@"10.1.2.17:8081"];
        self.photoURL = [NSURL URLWithString:[photoObj objectForKey:@"filepath"]];
    }else{
