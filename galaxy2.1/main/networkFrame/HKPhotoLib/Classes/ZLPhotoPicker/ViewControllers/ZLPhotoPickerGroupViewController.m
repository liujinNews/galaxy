...
- (void) setupButtons{
    UIBarButtonItem *barItem = [[UIBarButtonItem alloc] initWithTitle:Custing(@"关闭", nil) style:UIBarButtonItemStyleDone target:self action:@selector(back)];
    barItem.tintColor=[GPUtils colorHString:@"#797979"];
