...
#import "JQScanVideoZoomView.h"

@interface JQScanVideoZoomView()

@property (nonatomic, strong) UISlider *slider;

@end

@implementation JQScanVideoZoomView

- (void)drawRect:(CGRect)rect
{
    // Drawing code
    
    UIColor *colorLine = Color_form_TextFieldBackgroundColor;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    [self.slider setThumbImage:[self toImage:Color_form_TextFieldBackgroundColor size:CGSizeMake(3, 12)] forState:UIControlStateNormal];
    self.slider.minimumTrackTintColor = Color_form_TextFieldBackgroundColor;
